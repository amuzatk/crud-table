...
const ANIMATION_DURATION = '500ms'; // Reduce animation duration for better user experience
...
export class AppComponent implements OnInit {
  ...
  saveUser() {
    ...
    if (this.selectedUserForEdit) {
      ...
      this.userService
        .updateUser(this.selectedUserForEdit)
  ...
  getSeverity(status: string) {
    switch (status) {
      // Add cases for different statuses if needed
    }
  }
}
